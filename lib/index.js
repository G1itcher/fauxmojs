  ...
  init(devicesOptions) {
    ...
    for(let device of deviceOptions)
    {
      /*
        ...
        var gary = new bob.constructor)
        console.log(bob.constructor.staticMethod())
        console.log(bob.constructor.staticGetter)
      */
    }
...
USN: uuid:Socket-1_0-${k}::urn:Belkin:device:**\r\n\r\n`;
  ...
  generateBelkinSetupXml(name, id){
